...
namespace SenseNet.ContentRepository.Tests.ContentHandlers
{
    ...
    {
        public static string ContentTypeDefinition = @"<?xml version='1.0' encoding='utf-8'?><ContentType name='TestSystemFolder' parentType='SystemFolder' handler='SenseNet.ContentRepository.Tests.ContentHandlers.TestSystemFolder' xmlns='http://schemas.sensenet.com/SenseNet/ContentRepository/ContentTypeDefinition' />";
