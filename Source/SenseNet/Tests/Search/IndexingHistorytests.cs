...
namespace SenseNet.ContentRepository.Tests.Search
{
    ...
    public class IndexingHistorytests : TestBase
    {
        ...
        public void IndexingHistory_CheckForUpdate()
        {
            ...
            Assert.IsTrue(history.CheckForUpdate(42, new Timestamps(1111, 1111)), "CheckForAdd(42, 1111) first call returned with false");
            Assert.IsFalse(history.CheckForUpdate(42, new Timestamps(1111, 1111)), "CheckForUpdate(42, 1111) second call returned with true");
            Assert.IsFalse(history.CheckForUpdate(42, new Timestamps(1110, 1110)), "CheckForUpdate(42, 1110) returned with true");
            Assert.IsTrue(history.CheckForUpdate(42, new Timestamps(1112, 1112)), "CheckForUpdate(42, 1112) returned with false");
            Assert.IsTrue(history.CheckForUpdate(42, new Timestamps(1113, 1113)), "CheckForUpdate(42, 1113) returned with false");

            Assert.IsTrue(history.CheckForUpdate(43, new Timestamps(1111, 1111)), "CheckForAdd(43, 1111) first call returned with false");
            Assert.IsFalse(history.CheckForUpdate(43, new Timestamps(1111, 1111)), "CheckForUpdate(43, 1111) second call returned with true");
            Assert.IsFalse(history.CheckForUpdate(43, new Timestamps(1110, 1110)), "CheckForUpdate(43, 1110) returned with true");
            Assert.IsTrue(history.CheckForUpdate(43, new Timestamps(1112, 1112)), "CheckForUpdate(43, 1112) returned with false");
            Assert.IsTrue(history.CheckForUpdate(43, new Timestamps(1113, 1113)), "CheckForUpdate(43, 1113) returned with false");
        ...
        public void IndexingHistory_ProcessDelete()
        {
            ...
            Assert.IsFalse(history.CheckForAdd(42, new Timestamps(1111, 1111)), "CheckForAdd(42, 1111) returned with true");
            Assert.IsFalse(history.CheckForUpdate(42, new Timestamps(1112, 1112)), "CheckForUpdate(42, 1112) returned with true");
