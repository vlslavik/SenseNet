...
namespace SenseNet.Diagnostics
{
    public static class Utility
    {
        ...
        internal static IDictionary<string, object> GetDefaultProperties(object target)
        {
            ...
            t = target.GetType();
            if (t.FullName == "SenseNet.Search.Indexing.Activities.DistributedLuceneActivity+LuceneActivityDistributor")
            {
        ...
        private static void CollectContextProperties(IDictionary<string, object> properties)
        {
            if (!properties.ContainsKey("WorkingMode"))
                properties.Add("WorkingMode", SenseNet.ContentRepository.Storage.Data.RepositoryConfiguration.WorkingMode.RawValue);
