    ...
    public class PropertyEditorPart : EditorPart
    {
        ...
        public static string GetCategoryTitle(PropertyDescriptor propertyDescriptor)
        {
            ...
            if (category == null)
            {
                ...
                return SenseNetResourceManager.Current.GetString("PortletFramework", "EditorCategory_Other");
            }

            return String.IsNullOrEmpty(category.Title) ? string.Empty : SenseNetResourceManager.Current.GetString(category.Title);
        }
