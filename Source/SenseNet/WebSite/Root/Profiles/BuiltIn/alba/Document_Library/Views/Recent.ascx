...
<span disabled="disabled" class="sn-actionlinkbutton sn-disabled"><img class="sn-icon sn-icon16" title="<%# ((SNCR.Content)Container.DataItem).ContentHandler.Locked ? "Locked by " + ((SNCR.Content)Container.DataItem).ContentHandler.LockedBy.Name : string.Empty %>" alt="[locked]" src="/Root/Global/images/icons/16/checkin.png"></span>
</asp:PlaceHolder>
          </asp:TableCell>
