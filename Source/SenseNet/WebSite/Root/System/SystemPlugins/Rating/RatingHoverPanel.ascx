...
<div class="rating-popup">
    <div class="rating-inside">
        <table cellspacing="0" cellpadding="0">
            <tr>
                <td>
                    <img src="/Root/Skins/sensenet/images/rating-bf.png" />
                </td>
                <td class="rating-tooltip-bg">
                </td>
                <td>
                    <img src="/Root/Skins/sensenet/images/rating-jf.png" />
                </td>
            </tr>
            <tr>
                <td class="rating-tooltip-bg">
            ...
            <tr>
                <td>
                    <img src="/Root/Skins/sensenet/images/rating-ba.png" />
                </td>
                <td class="rating-tooltip-bg">
                </td>
                <td>
                    <img src="/Root/Skins/sensenet/images/rating-ja.png" />
                </td>
            </tr>
        </table>
    </div>
