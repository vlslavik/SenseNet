...
<asp:LoginView ID="LoginViewControl" runat="server">
    ...
    <LoggedInTemplate>
        <div id="snm-loggedin" class="snm-tile snm-tile-wide5">
            <div class="snm-floatleft snm-avatar"><img src="<%= SenseNet.Portal.UI.UITools.GetAvatarUrl(80, 80) %>" alt="" title="<%= SenseNet.ContentRepository.User.Current.FullName %>" /></div>
            <h2><%=GetGlobalResourceObject("LoginPortlet", "Welcome")%> <%= SenseNet.ContentRepository.User.Current.FullName %>!</h2>
