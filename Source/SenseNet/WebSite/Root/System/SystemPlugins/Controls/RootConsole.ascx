<%@ Control Language="C#" AutoEventWireup="true" %>
    ...
    <div class="sn-rootc">
        ...
        <div class="sn-rootc-right">
            ...
            <div class="sn-content">
                <div class="sn-pic-left">
                    <a href="http://wiki.sensenet.com" target="_blank"><sn:SNIcon Icon="rc-wiki" ID="ImgWiki" Size="64" runat="server" /></a>
                </div>
                <div class="sn-rootc-text">
                    <div class="sn-rootc-header">
                        <h1 class="sn-content-title">
            ...
            <div class="sn-content">
                <div class="sn-pic-left">
                    <a href="http://forum.sensenet.com/" target="_blank"><sn:SNIcon Icon="rc-forum" ID="ImgForum" Size="64" runat="server" /></a>
                </div>
                <div class="sn-rootc-text">
                    <div class="sn-rootc-header">
                        <h1 class="sn-content-title">
            ...
            <div class="sn-content">
                <div class="sn-pic-left">
                    <a href="http://www.sensenet.com/" target="_blank"><sn:SNIcon Icon="rc-salesinfo" ID="ImgSalesInfo" Size="64" runat="server" /></a>
                </div>
                <div class="sn-rootc-text">
                    <div class="sn-rootc-header">
                        <h1 class="sn-content-title">
