...
SN.Wall = {
    postDefaultText: SN.Resources.Portal["PostSomething"],
    shareDefaultText: SN.Resources.Portal["WriteSomething"],
    commentDefaultText: SN.Resources.Portal["WriteSomething"],
    createOtherDefaultText: SN.Resources.Portal["StartTyping"],
    likeListDialogConf: {
        title: SN.Resources.Picker["PeopleWhoLikeThisItem"],
        modal: true,
        zIndex: 10000,
        width: 320,
        height: 'auto',
    ...
    shareDialogConf: {
        title: SN.Resources.Picker["PostThisToAWall"],
        modal: true,
        zIndex: 10000,
        width: 400,
        height: 'auto',
    ...
    dropboxSelect: function ($this, $div) {
        $('.sn-dropboxdiv').hide();
        $div.show();
        $('.sn-dropbox-buttons span').removeClass('sn-dropbox-buttons-selected');
