...
// using $skin/scripts/codemirror-3.14/lib/codemirror.js
// using $skin/scripts/codemirror-3.14/lib/codemirror.css
// resource Picker
...
SN.BinaryFieldControl = {
    initHighlightTextbox: function (extension) {
        ...
        $.getScript("/Root/Global/scripts/codemirror-3.14/mode/javascript/javascript.js", function () {
        ...
        $.getScript("/Root/Global/scripts/codemirror-3.14/mode/css/css.js", function () {
            editor = CodeMirror.fromTextArea($textfield[0], {
                height: "600px",
                lineNumbers: true,
                matchBrackets: true,
            ...
            $.getScript("/Root/Global/scripts/codemirror-3.14/mode/xml/xml.js", function () {
                editor = CodeMirror.fromTextArea($textfield[0], {
