...
<%
    ...
    var canSave = PortalContext.Current.ContextNode.Security.HasPermission(SenseNet.ContentRepository.User.Current, SenseNet.ContentRepository.Storage.Schema.PermissionType.Save);
%>
...
<script>
    $(function () {
        ...
        var uploadEnabled = '<% PortalContext.Current.ContextNode.Security.HasPermission(SenseNet.ContentRepository.User.Current, SenseNet.ContentRepository.Storage.Schema.PermissionType.Save);%>';
