...
namespace SenseNet.Tools.Lucene.IndexPopulator
{
    class Populator
    {
        ...
        //   012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789
            ...
            CR,
            "Parameters:", CR,
            "<source>:    Sense/Net Content Repository path as the root (default: /Root)", CR,
        ...
        private static void Run(string repositoryPath, string indexPath, string asmPath, bool backup)
        {
                ...
                new SenseNet.ContentRepository.RepositoryStartSettings { Console = Console.Out, StartLuceneManager = false, StartWorkflowEngine = false, PluginsPath = asmPath }))
            {
                ...
                SenseNet.ContentRepository.Storage.Data.RepositoryConfiguration.WorkingMode.Populating = true;
