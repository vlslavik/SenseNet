...
namespace SenseNet.ContentRepository
{
    ...
    public class Aspect : GenericContent
    {
        ...
        {
            if (StorageContext.Search.IsOuterEngineEnabled && StorageContext.Search.SearchEngine != SenseNet.ContentRepository.Storage.Search.InternalSearchEngine.Instance)
