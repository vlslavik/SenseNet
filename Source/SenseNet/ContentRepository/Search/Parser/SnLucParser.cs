...
namespace SenseNet.Search.Parser
{
    ...
    internal class SnLucParser
    {
        ...
        private class FieldInfo
        {
            ...
            public PerFieldIndexingInfo IndexingInfo
            {
                get
                {
                    ...
                    {
                        _indexingInfo = SenseNet.ContentRepository.Schema.ContentTypeManager.GetPerFieldIndexingInfo(this.Name);
        ...
        static string[] _headOnlyFields = SenseNet.ContentRepository.Storage.Node.GetHeadOnlyProperties();
