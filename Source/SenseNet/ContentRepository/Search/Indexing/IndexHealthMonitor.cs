...
namespace SenseNet.Search.Indexing
{
    internal static class IndexHealthMonitor
    {
        ...
        internal static void Start(System.IO.TextWriter consoleOut)
        {
            ...
            if (consoleOut == null)
                return;
            consoleOut.WriteLine("IndexHealthMonitor started. Frequency: {0} s", SenseNet.ContentRepository.Storage.Data.RepositoryConfiguration.IndexHealthMonitorRunningPeriod);
        }
