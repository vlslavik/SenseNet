...
namespace SenseNet.ContentRepository
{
    ...
    public class RepositoryVersionInfo
    {
        ...
        private static RepositoryVersionInfo Create()
        {
            ...
            {
                OfficialSenseNetVersion = DataProvider.Current.LoadOfficialSenseNetVersion(),
                Applications = DataProvider.Current.LoadInstalledApplications(),
                ...
                InstalledPackages = DataProvider.Current.LoadInstalledPackages()
            };
        }
