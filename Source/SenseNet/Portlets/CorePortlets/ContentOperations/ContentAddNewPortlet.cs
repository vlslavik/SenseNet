        ...
        protected override void CreateChildControls()
        {
            ...
            if (_currentUserControl != null)
            {
                ...
                else
                {
                    ...
                    if (_currentContent != null)
                    {
                        Logger.WriteError(Logger.EventId.NotDefined, string.Format("Forbidden content type ({0}) under {1}", _currentContent.ContentType.Name, _currentContent.ContentHandler.ParentPath));
